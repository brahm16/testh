          ...
          <div className='mt-12 flex flex-col items-center'>
            ...
            >
              <div className='mx-auto max-w-xs relative '>
                ...
                />
                <input
                  className='w-full px-8  rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white mt-5'
                  type='email'
                  placeholder='Email'
           ...
           bg-indigo-100 text-gray-800 items-center  transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5'
                  href='/login'
                  target='_self'
                >
